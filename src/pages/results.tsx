...
export default function Results() {
  ...
  useEffect(() => {
    const { startDate: start, endDate: end } = getDateRangeFromNow(30);
    setStartDate(start);
    setEndDate(end);
  }, []);
  ...
  return (
    <>
      <Head>
        <title>Cricket Results - CricCode</title>
        <meta name="description" content="Browse completed cricket matches and results" />
